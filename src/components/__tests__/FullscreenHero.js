...
describe("FullscreenHero", () => {
  ...
  it("Renders the background video", () => {
    ...
    expect(src).toMatch(
      "https://player.vimeo.com/video/468693933?background=1&autoplay=1&title=0&byline=0&portrait=0"
    );
  });
  ...
  it("Renders scroll indicator", () => {
    ...
    const target = container.getElementsByClassName("test__scroll")[0];
    expect(target.textContent).toMatch("Scroll for more");
  });
});
